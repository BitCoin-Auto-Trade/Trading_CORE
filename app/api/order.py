...
@router.get("/exchange-info", summary="거래소 규칙 정보 조회")
def get_exchange_info():
    """ 거래소에 상장된 모든 심볼의 거래 규칙(최소 주문량, 가격/수량 정밀도 등)을 가져옵니다. """
